...
from agent_workflow_semantic import run_semantic_workflow

def langgraph_semantic_batch_run(jd_dir: str, resume_path: str, output_dir: str) -> None:
    ...
    for jd_file in jd_files:
        ...
        final_state = run_semantic_workflow(
            jd_path=str(jd_file),
...
if __name__ == "__main__":
    langgraph_semantic_batch_run(
        jd_dir="data/job_descriptions",
        resume_path="data/resumes/my_resume.txt",
        output_dir="results/langgraph_semantic_batch_decisions"
    )