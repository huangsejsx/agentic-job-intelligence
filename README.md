...
7. Score breakdown 能让 decision score 的来源更加透明；
...
5. 当前 semantic score 还没有细粒度区分 required skills 和 preferred skills 的不同权重；
...
5. 将 required / preferred skill weighting 扩展到 semantic scoring；
